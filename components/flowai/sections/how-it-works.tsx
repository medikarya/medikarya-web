...
import { Stethoscope, TestTube, FileText, ArrowRight, CheckCircle, Clock, Users, Activity, MessageSquare, Zap } from "lucide-react"
  ...
  const steps = [
    {
      ...
      desc: "Engage in dynamic conversations with AI patients presenting realistic symptoms.",
      icon: Stethoscope,
      color: "bg-brand-50",
    ...
    },
    {
      ...
      duration: "3-5 min",
      bottomIcon: Zap,
      bottomLabel: "Instant Results",
      hoverBorder: "hover:border-purple-200"
    },
    {
      title: "Clinical Decision Making",
      subtitle: "AI-Guided Diagnosis",
      desc: "Analyze results, formulate diagnoses, and develop comprehensive treatment plans.",
      icon: FileText,
      color: "bg-green-50",
      ...
      bottomLabel: "Personalized Feedback",
    ...
    >
      <div className="mx-auto max-w-4xl text-center mb-12 sm:mb-16">
        ...
        <p className={cn(
          ...
          Each session delivers clinical accuracy with evidence-based learning pathways.
        </p>
      </div>
              ...
              <div className={`group relative overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm hover:shadow-md ${step.hoverBorder} transition-all duration-200 hover:-translate-y-[1px] h-full flex flex-col`}>
                <div className="p-6 sm:p-8 flex-1 flex flex-col">
                  ...
                  <div className="mb-4 sm:mb-6">
                    <div className={`inline-flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-2xl ${step.color} transition-transform duration-300 group-hover:scale-105`}>
                      <Icon className={`h-7 w-7 sm:h-8 sm:w-8 ${step.iconColor}`} />
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 flex-1">
                    <div className="flex-1">
                      <h3 className="text-xl font-bold mb-1.5 text-slate-900 transition-colors duration-300 group-hover:text-brand-700">
                        {step.title}
                      </h3>
                      <p className="text-sm font-medium text-brand-600 mb-2.5">
                        {step.subtitle}
                      </p>
                    ...
                    <Accordion type="single" collapsible className="w-full">
                      <AccordionItem value="item-1" className="border-none">
                        <AccordionTrigger className="text-xs font-medium text-slate-500 hover:text-brand-600 py-2">
                          View details
                        </AccordionTrigger>
                        <AccordionContent>
                  ...
                  <div className="pt-4 border-t border-slate-100 mt-auto">
                    <div className="flex items-center justify-between text-xs sm:text-sm">
                      <div className="flex items-center gap-1.5 text-slate-600 font-medium">
                        <step.bottomIcon className="h-3.5 w-3.5 text-brand-500" />
                        <span>{step.bottomLabel}</span>
                      </div>
                      <div className="flex items-center gap-1.5 rounded-full bg-slate-100 px-2.5 py-1 text-slate-600">
